...
return [
    ...
    | utilizados por la clase del validador. Algunas de estas reglas tienen múltiples
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Las siguientes líneas de idioma se utilizan para intercambiar el marcador de posición
    | de nuestro atributo con algo más amigable para el lector, como "Dirección de correo electrónico" en lugar
